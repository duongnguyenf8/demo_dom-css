/*! For license information please see main.6a1c97d4.js.LICENSE.txt */
!(function () {
  'use strict';
  var e = {
      463: function (e, t, n) {
        ...
        var Bl = {
          ...
          enqueueSetState: function (e, t, n) {
            ...
            (l.payload = t),
              ...
              null !== (t = jl(e, l, a)) && (rs(t, e, a, r), Ml(t, e, a));
          },
          ...
          enqueueForceUpdate: function (e, t) {
            ...
            (a.tag = 2),
              ...
              null !== (t = jl(e, a, r)) && (rs(t, e, r, n), Ml(t, e, r));
          },
        };
        ...
        function Hl(e, t, n, r) {
          ...
          'object' === typeof l && null !== l
            ? (a.context = _l(l))
            : ((l = Ta(t) ? Oa : Na.current), (a.context = La(e, l))),
        ...
        function Ni(e, t, n, r, a) {
          ...
          if ((El(t, a), null === t.stateNode))
            ...
            (o.state = d),
              Dl(t, r, o, a),
              (u = t.memoizedState),
              i !== r || d !== u || za.current || Ol
                ? ('function' === typeof c &&
                    (Al(t, n, c, r), (u = t.memoizedState)),
                  (i = Ol || $l(t, n, i, r, d, u, s))
                    ? (f ||
            ...
            i !== f || d !== h || za.current || Ol
              ? ('function' === typeof p &&
                  (Al(t, n, p, r), (h = t.memoizedState)),
                (s = Ol || $l(t, n, s, r, d, h, u) || !1)
                  ? (c ||
        ...
        function Ms(e, t, n, r, a, o) {
          ...
          if (((r = e), 'function' === typeof e)) Rs(e) && (i = 1);
            ...
            e: switch (e) {
              ...
              case O:
                return (
                  ((e = Ts(19, n, t, a)).elementType = O), (e.lanes = o), e
                );
              case R:
                return Ds(n, a, o, t);
              default:
        ...
        function Vs(e, t, n, r) {
          ...
          return (
            ...
            null !== (e = jl(a, t, o)) && (rs(e, a, o, l), Ml(e, a, o)),
            o
          );
        }
        function Hs(e) {
    ...
    (function () {
      ...
      function _e(e, n, r) {
        ...
        if (null != i) {
          ...
          u >= 0 || N(!1), (o = o.slice(0, Math.min(o.length, u + 1)));
        }
        ...
        S =
          'function' === typeof u
            ...
            : [u, x ? 'active' : null, E ? 'pending' : null]
                .filter(Boolean)
                .join(' ');
        var C = 'function' === typeof f ? f({ isActive: x, isPending: E }) : f;
        return t.createElement(
          He,
          De({}, h, {
            'aria-current': _,
      ...
      var Ye = { header: 'headerStyles_header__GEtQL' },
        Xe = n(184);
      function Ge(e) {
        var t = e.className,
          n = void 0 === t ? '' : t,
          r = e.children,
          a = Ye.header;
        return (0, Xe.jsx)('header', {
          className: ''.concat(a, ' ').concat(n),
          children: (0, Xe.jsx)('div', { className: 'container', children: r }),
        });
      }
      function Je(e, t, n) {
        return (
      ...
      var tt = { main: 'mainStyles_main__DIfMc' };
      function nt(e) {
        var n = e.className,
          r = void 0 === n ? '' : n,
          a = e.children,
          l = e.store,
          o = tt.main;
        return (0, Xe.jsx)('main', {
          className: ''.concat(o, ' ').concat(r),
          children: (0, Xe.jsx)('div', {
            className: 'container',
            children: (0, t.cloneElement)(a, et({}, l)),
          }),
        });
      }
      var rt = { footer: 'footerStyles_footer__L7uM8' };
      function at(e) {
        var t = e.className,
          n = void 0 === t ? '' : t,
          r = e.children,
      ...
      var ct = {
        wrap: 'avatar_wrap__nDugu',
        avatar: 'avatar_avatar__ks12v',
        name: 'avatar_name__Uhvmv',
      };
      function ft(e) {
        var t = e.name,
          n = ct.wrap,
        ...
        if (!t || 'string' !== typeof t)
          return (0, Xe.jsxs)(st, {
            ...
            className: n,
            children: [
              (0, Xe.jsx)('span', { className: r, children: 'A' }),
              ' ',
              (0, Xe.jsx)('span', { className: a, children: 'Avatar' }),
            ],
          });
        var l = (t = t.replace(/\s{2,}/g, ' ').trim()).charAt(0).toUpperCase(),
          o = t.lastIndexOf(' ') + 1;
        return (0, Xe.jsxs)(st, {
          to: '#',
          className: n,
          children: [
            (0, Xe.jsx)('span', {
              className: r,
              'data-name': t.charAt(o),
              alt: t,
            }),
            ' ',
            (0, Xe.jsx)('span', { className: a, children: l + t.slice(1) }),
          ],
        });
      }
      var dt = { tag: 'tagStyles_tag__6eEzC' };
      function pt(e) {
        var t = e.to,
          n = void 0 === t ? '#' : t,
          r = e.text,
        ...
        return (0, Xe.jsx)(st, {
          to: n,
          className: ''.concat(o, ' ').concat(l),
          children: r.toLowerCase().trim(),
        });
      }
      function ht(e) {
        var t = e.children;
        return (0, Xe.jsxs)(Xe.Fragment, {
          children: [
            (0, Xe.jsx)(Ge, {
              children: (0, Xe.jsx)(ft, { name: 'F8 Offline' }),
            }),
            (0, Xe.jsx)(ut, {
              children: (0, Xe.jsx)(it, {
                children: function (e) {
                  return (0, Xe.jsx)(nt, { store: e, children: t });
                },
              }),
            }),
            (0, Xe.jsx)(at, {
              children: (0, Xe.jsx)(pt, {
      ...
      var mt = {
        button: 'buttonStyles_button__sgt6c',
        secondary: 'buttonStyles_secondary__MmMN5',
        primary: 'buttonStyles_primary__caXcQ',
      };
      function vt(e) {
        var t = e.type,
        ...
        return (0, Xe.jsx)('button', {
          className: ''.concat(s, ' ').concat(d, ' ').concat(a, ' '),
          onClick: i,
          disabled: u,
          title: l,
          children: l || o,
      ...
      var yt = '../media/notify.svg',
        gt = {
          ...
          'top-left': 'notifyStyles_top-left__dpv7L',
          'top-right': 'notifyStyles_top-right__Kh0t0',
          'bottom-left': 'notifyStyles_bottom-left__G0gei',
          'bottom-right': 'notifyStyles_bottom-right__MpvHt',
          success: 'notifyStyles_success__hV7eL',
          failed: 'notifyStyles_failed__oTTlH',
          message: 'notifyStyles_message__lXgRY',
          timeline: 'notifyStyles_timeline__SYEcz',
          line: 'notifyStyles_line__18AOF',
          animateTime: 'notifyStyles_animateTime__VnF4v',
        };
      function bt(e) {
        var n = e.message,
          r = void 0 === n ? '' : n,
        ...
        return (
          ...
          (0, Xe.jsxs)('div', {
            className: z,
            style: { animationDuration: ''.concat(i, 's') },
            onMouseOver: function () {
              (v.current.style.animationPlayState = 'paused'),
                (y.current.style.animationPlayState = 'paused'),
                m(!0);
            },
            onMouseOut: function () {
              (v.current.style.animationPlayState = 'running'),
                (y.current.style.animationPlayState = 'running'),
                m(!1);
            },
            ref: v,
            children: [
              (0, Xe.jsxs)('span', {
                className: k,
                children: [r, '!' !== r.slice(-1) ? '!' : ''],
              }),
              (0, Xe.jsx)('img', { src: yt, alt: r, className: E }),
              (0, Xe.jsx)('div', {
                className: ''.concat(S, ' ').concat('success' === l ? b : w),
                children: (0, Xe.jsx)('div', {
                  className: ''.concat(x),
                  style: { animationDuration: ''.concat(i / 1.2, 's') },
                  ref: y,
                }),
              }),
            ],
      ...
      var wt = { section: 'sectionStyles_section__PeYS9' };
      function kt(e) {
        var t = e.className,
          n = void 0 === t ? '' : t,
          r = e.children,
          a = wt.section;
        return (0, Xe.jsx)('section', {
          className: ''.concat(a, ' ').concat(n),
          children: r,
        });
      }
      function St() {
        ...
        return (0, Xe.jsxs)(kt, {
          children: [
            (0, Xe.jsx)(ft, { name: 'N\xf3i chung c\u0169ng nh\xe0n' }),
            (0, Xe.jsx)(vt, {
              title: 'Home',
              onClick: function () {
                e('/demo-dom-css/');
            ...
            (0, Xe.jsx)(bt, { message: 'Hello World!', position: 'top-right' }),
            (0, Xe.jsx)(bt, {
              message: 'Hello World!',
              type: 'failed',
              timeout: '4',
      ...
      function xt() {
        ...
        return (0, Xe.jsxs)(kt, {
          children: [
            (0, Xe.jsx)(ft, { name: 'H\u1ecdc L\u1eadp tr\xecnh' }),
            (0, Xe.jsx)(vt, {
              title: 'About',
              onClick: function () {
                e('/demo-dom-css/about');
              },
            }),
            (0, Xe.jsx)(vt, {
              title: 'About',
            ...
            (0, Xe.jsx)(bt, { message: 'Hello World!', type: 'success' }),
            (0, Xe.jsx)(bt, {
              message: 'Hello World!',
              type: 'failed',
              timeout: '4',
      ...
      function _t() {
        return (0, Xe.jsxs)(Re, {
          children: [
            ...
            (0, Xe.jsx)(Le, {
              path: '/demo-dom-css/about',
              element: (0, Xe.jsx)(St, {}),
            }),
            (0, Xe.jsx)(Le, {
              path: '*',
              element: (0, Xe.jsx)(Et, { path: '/demo-dom-css/' }),
            }),
          ],
        });
      }
      var Ct = function () {
        return (0, Xe.jsx)($e, {
          children: (0, Xe.jsx)(ht, { children: (0, Xe.jsx)(_t, {}) }),
        });
      };
      a.createRoot(document.getElementById('root')).render(
        (0, Xe.jsx)(t.StrictMode, { children: (0, Xe.jsx)(Ct, {}) })
      );
    })();
})();
